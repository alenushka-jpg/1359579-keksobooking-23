...
(function () {
  ...
  let renderCard = function (ad) {
    ...
    paragraphs[2].textContent('.popup__text--capacity') = ad.offer.rooms + ' комнаты для ' + ad.offer.guests + ' гостей';
    paragraphs[2].textContent('.popup__text--time') = 'Заезд после ' + ad.offer.checkin + ', выезд до ' + ad.offer.checkout;
    ...
    paragraphs[4].textContent('.popup__description') = ad.offer.description;
